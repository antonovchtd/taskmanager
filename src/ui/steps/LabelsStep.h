...
#ifndef TASKMANAGER_SRC_UI_STEPS_LABELSSTEP_H_
#define TASKMANAGER_SRC_UI_STEPS_LABELSSTEP_H_

#include "Step.h"
#include "utilities/StepUtils.h"
#include "ui/actions/DoNothingAction.h"

class LabelsStep : public Step {
public:
    using Step::Step;
...
#endif //TASKMANAGER_SRC_UI_STEPS_LABELSSTEP_H_
