...
//    EXPECT_EQ(c.task().title(), "test");
//    EXPECT_EQ(c.task().priority(), ProtoTask::Task_Priority_MEDIUM);
//    time_t rawtime;
//    time(&rawtime);
...
//    EXPECT_EQ(c.task().due_date(), mktime(timeinfo));
//    EXPECT_EQ(action, f->lazyInitAction(a));
//}
//
...
//    step->process(c);
//
//    EXPECT_EQ(out, "Task " + std::to_string(c.id()->num()) +
...
//    EXPECT_EQ(c.task().title(), "test");
//    EXPECT_EQ(c.task().priority(), ProtoTask::Task_Priority_LOW);
//    time_t rawtime;
//    time(&rawtime);
//    struct tm * timeinfo = localtime(&rawtime);
//    timeinfo->tm_hour = 0;
...
//    EXPECT_EQ(out3, "    Due {Format: dd[/.]mm[/.](/(yy)yy) (hh:mm)} > ");
//    EXPECT_EQ(c.task().title(), "test");
//    EXPECT_EQ(c.task().priority(), ProtoTask::Task_Priority_HIGH);
//    time_t rawtime;
//    time(&rawtime);
//    struct tm * timeinfo = localtime(&rawtime);
//    timeinfo->tm_hour = 23;
...
//    EXPECT_EQ(out, "Added Task with ID " + std::to_string(c.id()->num()) + ".\n");
//}
//
...
//    EXPECT_EQ(out, "Edited Task with ID " + std::to_string(c.id()->num()) + ".\n");
//}
//
...
//    EXPECT_EQ(out, "Added Subtask with ID " + std::to_string(c.id()->num()) + ".\n");
//}
//
...
//    ProtoTask::Task t;
//    t.set_title("test");
//    t.set_priority(ProtoTask::Task_Priority_MEDIUM);
//    t.set_due_date(1767218399);
//    t.set_label("");
//    t.set_is_complete(false);
//    tm.Add(t);
//
...
//    auto id = tm.Add(t);
//    t.set_title("sub");
//    t.set_priority(ProtoTask::Task_Priority_LOW);
//    t.set_label("b");
//    tm.AddSubtask(t, id);
//
//    auto ss = f->lazyInitStep(Factory::State::SHOW);
...
//    EXPECT_EQ(out, "Marked Task with ID " + std::to_string(c.id()->num()) + " as completed.\n");
//}
//
...
//    EXPECT_EQ(out, "Deleted Task with ID " + std::to_string(c.id()->num()) + ".\n");
//}
//
...
//    EXPECT_EQ(out, "Added label to Task with ID " + std::to_string(c.id()->num()) + ".\n");
//}